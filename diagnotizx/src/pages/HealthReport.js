...
const HealthReport = () => {
  ...
  return (
    <div className="health_container">
      ...
      <button className="consult-doctor-btn" onClick={() => setShowConsultModal(true)}>Consult Doctor</button>
      {/* Consult Doctor Modal */}
      {showConsultModal && (
        <div className="consult-modal-overlay">
          <div className="consult-modal">
            <span className="close-btn" onClick={() => setShowConsultModal(false)}>&times;</span>
            <h3>Consult a Doctor</h3>
            <div className="consult-options">
              <div className="consult-card" onClick={() => navigate("/videoConsult")}>
                <h4>Audio/Video Consultation</h4>
                <p>Speak to a doctor online for quick medical advice.</p>
              </div>
              <div className="consult-card" onClick={() => navigate("/specialConsult")}>
                <h4>For People with Health Conditions</h4>
                <p>Special consultation for those with pre-existing health conditions or impairments.</p>
              </div>
            </div>
          </div>
        </div>
